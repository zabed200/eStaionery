...
<div class="col-sm-4 col-lg-4 col-md-4">
    <div class="thumbnail">
        ...
        <div class="caption">
            <h4 class="pull-right" style="display:block;font-weight:bold;">&#36;{$row['product_price']}</h4>
            <h4><a href="item.php?id={$row['product_id']}">{$row['product_title']}</a></h4>
            <p>{$row['short_desc']}</p>
            <p class="text-center user-btn"><a class="btn btn-primary" target="_blank" href="../resources/cart.php?add={$row['product_id']}">Add to cart</a>
            </a> <a href="item.php?id={$row['product_id']}" class="btn btn-default">Read More</a></p>
        </div>
    </div>
</div>
            ...
            <div class="col-md-3 col-sm-6 hero-feature">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p>{$row['short_desc']}</p>
                        <p>
                            <a href="../resources/cart.php?add={$row['product_id']}" class="btn btn-primary">Buy Now!</a> <a href="item.php?id={$row['product_id']}" class="btn btn-default">Read More</a>
                        </p>
                    </div>
                </div>
            </div>
...
confirm($query);
    // echo '<pre>'; print($query->num_rows); echo '</pre>';
